...
select Restaurant_Name,sum(Order_Amount) as Total_Revenue from Zomato_Orders join Zomato_Restaurants 
on Zomato_Orders.Restaurant_ID=Zomato_Restaurants.Restaurant_ID group by Restaurant_Name;
...
select Restaurant_Name,sum(Order_Amount) as Total_Sales from Zomato_Orders join Zomato_Restaurants 
on Zomato_Orders.Restaurant_ID=Zomato_Restaurants.Restaurant_ID group by Restaurant_Name order by Total_Sales desc limit 5;
